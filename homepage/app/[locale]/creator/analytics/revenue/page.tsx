...
export default function RevenueAnalyticsPage() {
  const tCreator = useTranslations()
  ...
  const tCreator = (key: string) => {
    return revenueTranslations[key]?.['en'] || revenueTranslations[key]?.en || key
  }
      ...
      <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
        <Alert variant="destructive">
          ...
          <AlertDescription className="flex items-center justify-between">
            <span>{tCreator('failed_to_load'}: {error}</span>
  ...
  if (!data || (!data.totalRevenue && !data.totalOrders)) {
    return (
      <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">{tCreator('revenue_analytics'}</h1>
          <p className="text-gray-600 mt-1">{tCreator('track_earnings'}</p>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Select value={period} onValueChange={handlePeriodChange}>
              ...
              <SelectContent>
                <SelectItem value="7d">{tCreator('last_7_days'}</SelectItem>
                <SelectItem value="30d">{tCreator('last_30_days'}</SelectItem>
                <SelectItem value="90d">{tCreator('last_90_days'}</SelectItem>
                <SelectItem value="1y">{tCreator('last_year'}</SelectItem>
              </SelectContent>
            </Select>
            <Button
              variant="outline"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 hover:shadow-xl hover:border-purple-300 cursor-pointer transition-all duration-300">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">{tCreator('total_revenue'}</p>
              ...
              <div className="flex items-center mt-2">
                ...
                <span className="text-xs text-gray-500 ml-1">{tCreator('this_month'}</span>
              </div>
            </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 hover:shadow-xl hover:border-purple-300 cursor-pointer transition-all duration-300">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">{tCreator('total_orders'}</p>
              <p className="text-2xl font-bold text-gray-900">{data.totalOrders}</p>
              <div className="flex items-center mt-2">
                <Package className="h-4 w-4 text-blue-600 mr-1" />
                <span className="text-sm text-gray-500">
                  {data.monthlyStats.thisMonth.orders} {tCreator('this_month'}
                </span>
              </div>
            </div>
