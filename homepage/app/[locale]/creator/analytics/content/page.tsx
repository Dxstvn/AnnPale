...
export default function ContentAnalyticsPage() {
  ...
  const tContent = (key: string) => {
    return contentTranslations[key]?.['en'] || contentTranslations[key]?.en || key
  }
    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{tContent('content_performance')}</h1>
            <p className="text-gray-600 mt-1">{tContent('analyze_content')}</p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">{tContent('total_videos')}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">{tContent('total_views')}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">{tContent('avg_watch_time')}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">{tContent('completion_rate')}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">{tContent('engagement_rate')}</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid w-full max-w-md grid-cols-4">
          ...
          <TabsTrigger value="videos">{tContent('top_performing')}</TabsTrigger>
          <TabsTrigger value="metrics">{tContent('performance_metrics')}</TabsTrigger>
          <TabsTrigger value="engagement">{tContent('audience_engagement')}</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tContent('category_performance')}</CardTitle>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tContent('viewer_retention')}</CardTitle>
        ...
        <TabsContent value="videos" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{tContent('top_performing')}</CardTitle>
