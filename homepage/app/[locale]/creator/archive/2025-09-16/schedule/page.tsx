...
export default function CreatorSchedulePage() {
  ...
  const tSchedule = (key: string) => {
    return scheduleTranslations[key]?.['en'] || scheduleTranslations[key]?.en || key
  }
    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{tSchedule('availability_schedule')}</h1>
            <p className="text-gray-600 mt-1">{tSchedule('manage_availability')}</p>
          </div>
      ...
      <Card className="mb-6">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg">{tSchedule('quick_actions')}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-6 mb-6">
        <Card className={cn(
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>{tSchedule('availability_status')}</CardTitle>
                <CardDescription>
                  {tSchedule('toggle_availability')}
                </CardDescription>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <CardTitle>{tSchedule('weekly_schedule')}</CardTitle>
              <CardDescription>{tSchedule('set_regular')}</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{tSchedule('upcoming_bookings')}</CardTitle>
              <CardDescription>{tSchedule('scheduled_recordings')}</CardDescription>
            </CardHeader>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>{tSchedule('calendar_view')}</CardTitle>
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                  size="icon"
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>{tSchedule('blocked_dates')}</CardTitle>
                <CardDescription>{tSchedule('when_unavailable')}</CardDescription>
              </div>
            ...
            <Dialog open={isBlockDialogOpen} onOpenChange={setIsBlockDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" className="w-full">
                  ...
                  {tSchedule('block_dates')}
                </Button>
              </DialogTrigger>
              <DialogContent className="max-w-md">
                <DialogHeader>
                  <DialogTitle>{tSchedule('block_dates')}</DialogTitle>
                  <DialogDescription>
