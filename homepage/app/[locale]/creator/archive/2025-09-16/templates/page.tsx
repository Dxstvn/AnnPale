...
export default function CreatorTemplatesPage() {
  ...
  const tTemplate = (key: string) => {
    return templatesTranslations[key]?.['en'] || templatesTranslations[key]?.en || key
  }
    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-2">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{tTemplate('message_templates')}</h1>
            <p className="text-gray-600 mt-1">{tTemplate('create_manage')}</p>
          </div>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="name">{tTemplate('template_name')}</Label>
                    <Input
                      id="name"
                      value={formData.name}
                  ...
                  <div>
                    <Label htmlFor="category">{tTemplate('category')}</Label>
                    <Select 
                ...
                <div>
                  <Label htmlFor="content">{tTemplate('template_content')}</Label>
                  <Textarea
                    id="content"
      ...
      <div className="mb-6">
        <div className="relative max-w-md">
          ...
          <Input
            placeholder={tTemplate('search_templates')}
            value={searchQuery}
