...
export default function PreviewVideosPage() {
  ...
  const handlePlayVideo = (video: PreviewVideo | VideoRequest) => {
    if ('video_request_id' in video) {
      ...
      // Video request
      setSelectedVideo({
        title: `${video.occasion} for ${video.recipient_name}`,
        video_url: video.video_url,
        occasion: video.occasion,
        duration: video.duration
      })
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Preview Videos</h1>
          <p className="text-gray-600 mt-1">
            Manage the sample videos shown on your profile
          </p>
        </div>
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-medium text-sm truncate">
                              {video.occasion} for {video.recipient_name}
                            </h3>
