  ...
  const handleSwitchToCreatorMode = async () => {
    ...
    try {
      const response = await fetch('/api/account/switch-mode', {
        ...
        body: JSON.stringify({ mode: 'creator' })
      })
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        <div className="flex relative">
          ...
          >
            ...
            {/* Switch to Creator Studio Button for Dual-Role Users */}
            {isDualRoleUser && (
              <div className="px-4 pb-4 border-b border-gray-200">
                ...
                >
                  ...
                  {isSwitchingMode ? t('actions.switching') : t('actions.switchToCreatorStudio')}
                </Button>
                {!isSidebarCollapsed && (
                  <p className="text-xs text-gray-500 mt-2 px-1">
                    {t('actions.switchToCreatorDescription')}
                  </p>
                )}
              </div>
            )}
