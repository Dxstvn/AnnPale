...
export default function EnhancedAdminDashboard() {
  ...
  const tAdmin = (key: string) => {
    return adminTranslations[key]?.['en'] || adminTranslations[key]?.en || key
  }
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-80 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">{tAdmin('system_health'}</h2>
              <Button
                variant="ghost"
                size="sm"
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-8">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">{tAdmin('command_center'}</h1>
              <p className="text-gray-600 mt-1">{tAdmin('real_time_metrics'}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">{tAdmin('active_users'}</p>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">{tAdmin('today_revenue'}</p>
                      <p className="text-3xl font-bold text-gray-900 mt-2">
              ...
              <Card className="bg-gradient-to-br from-orange-50 to-yellow-50 border-orange-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">{tAdmin('pending_reviews'}</p>
                      <p className="text-3xl font-bold text-gray-900 mt-2">
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">{tAdmin('system_uptime'}</p>
                      <p className="text-3xl font-bold text-gray-900 mt-2">
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>{tAdmin('quick_actions'}</CardTitle>
            ...
            <Tabs defaultValue="activity" className="space-y-4">
              ...
              <TabsContent value="security" className="space-y-4">
                <Card>
                  <CardHeader>
                    <CardTitle>{tAdmin('security_status'}</CardTitle>
              ...
              <TabsContent value="performance" className="space-y-4">
                <Card>
                  <CardHeader>
                    <CardTitle>{tAdmin('performance_metrics'}</CardTitle>
        ...
        <aside className="w-80 bg-white border-l border-gray-200 overflow-y-auto">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">{tAdmin('critical_alerts'}</h2>
