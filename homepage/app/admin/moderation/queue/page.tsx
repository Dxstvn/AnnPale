...
export default function ModerationQueuePage() {
  ...
  const t = (key: string) => {
    return moderationTranslations[key]?.[language] || moderationTranslations[key]?.en || key
  }
    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">{t('content_moderation')}</h1>
            <p className="text-gray-700 dark:text-gray-300 mt-1">{t('review_flagged_content')}</p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('pending_review')}</p>
