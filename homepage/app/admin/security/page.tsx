...
export default function SecurityPage() {
  ...
  const t = (key: string) => {
    return securityTranslations[key]?.[language] || securityTranslations[key]?.en || key
  }
  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">{t('security_monitoring')}</h1>
        <p className="text-gray-600 mt-1">{t('platform_security')}</p>
      </div>
