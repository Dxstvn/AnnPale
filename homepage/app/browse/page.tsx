...
const categories = [
  ...
  { value: 'djProducer', label: 'DJ/Producer' },
  { value: 'radioHost', label: 'Radio Host' },
  { value: 'dj', label: 'DJ' },
]
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-lg text-gray-700">
                Find your favorite Haitian celebrities and book personalized video messages
              </p>
            </div>
          ...
          {loading ? (
            ...
            <Card className="col-span-full">
              <CardContent className="py-16 text-center">
                ...
                <h3 className="mb-2 text-2xl font-bold text-gray-900">No creators found</h3>
