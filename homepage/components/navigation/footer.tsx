      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Newsletter */}
            <div className="mb-6">
              <h4 className="font-medium mb-3 text-gray-900 dark:text-gray-100">Stay Updated</h4>
          ...
          {/* For Fans */}
          <div>
            <h4 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">For Fans</h4>
          ...
          {/* For Creators */}
          <div>
            <h4 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">For Creators</h4>
            <ul className="space-y-2">
