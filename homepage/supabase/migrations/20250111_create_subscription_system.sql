...
CREATE POLICY "Service role can manage all subscriptions" ON public.creator_subscriptions
...
BEGIN
  ...
  SELECT cs.tier_id INTO v_subscription_tier_id
  ...
  RETURN v_subscription_tier_price >= v_required_tier_price;
END;
$$ LANGUAGE plpgsql;
